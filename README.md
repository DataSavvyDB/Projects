...
**2. Talent BPC Database:** Utilizing SQL queries to extract relevant data.

**3. SAP AO Systems:** Extracting data from SAP AO systems using Python and Excel.

**4. Manual Excel Files and Mapping Tables:** Incorporating additional data from manual Excel files and mapping tables.

**5. Data Compilation Workflow**

**6. Python Script:** Utilized Python to compile and preprocess data from various sources.

**7. SQL Queries:** Executed SQL queries via SSMS for extracting data from the Talent BPC database.

**8. Data Transformation:** Employed Pandas library in Python for data transformation and cleaning.

**9. Data Concatenation:** Merged data from different sources to create a unified dataset for the dashboard.
